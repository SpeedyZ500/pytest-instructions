...
A negative test checks that the function **does not** return an incorrect result. Let's make up something incorrect by defining _A = {1}_ and _B = {1, 2}_, and then noting that _A ∪ B ≠ {1}_.
